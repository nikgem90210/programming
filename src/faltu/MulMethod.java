...
//	
//	
//	public MulMethod(int year, int month, int day){
//		this.year = year;
//		this.month = month;
//		this.day = day;
//	}
//	
//	public static void main(String[] args){
//		MulMethod birthday = new MulMethod();
//		birthday.year = 1989;
//		birthday.month = 10;
//		birthday.day = 02;
//		System.out.println("Using first constructor : " + birthday.day+":"+birthday.month+":"+birthday.year);
//		
//		
//		MulMethod b1 = new MulMethod(1989, 10, 02);
...
////		int start = 30;     // beginning of range  
////		int end = 50;      // end of range  
////		  for (int i=0;i<10;i++){
////			  int number = randomNumbers.nextInt( end - start + 1 );
...
//			a[i] =  (int) randomInt(50, 100);
//		}
//		return a;
//	}
//
//	private static double randomInt(int i, int j) {
