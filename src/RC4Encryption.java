...
public class RC4Encryption {
    ...
    public RC4Encryption(final byte[] key) {
...
//        byte[] text = {9,1,9,9,1,0,0,5,0,3,9,6}; // text as 12345
        ...
        RC4Encryption rc4 = new RC4Encryption(keytest);
	...
	private static String MD5ofKey(String algorithmMD5, String key) throws UnsupportedEncodingException, NoSuchAlgorithmException {
